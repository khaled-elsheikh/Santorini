...
public class missingNameExceptionWindow extends JFrame implements ActionListener {

	public missingNameExceptionWindow(){
		...
		JLabel exception = new JLabel("please enter your name");
